...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{Dupin-net.png}
    \caption{Net on Dupin surface.}
    \label{fig:net-on-dupin}
\end{figure}
...
\pagebreak
%===========================================================
\section{Circular cross sections of hyperboloids and their isometric deformation}
\subsection{Diagonally related parameterization for one-sheeted hyperboloid}
\subsection{Diagonally related parameterization for two-sheeted hyperboloid}
\subsection{Family of affine transformations isometric along circular cross-sections}
\begin{theorem}
